    ...
    return (
        <>
            ...
            <main className='flex flex-col gap-y-5 justify-center items-center'>
                ...
                <section className='grid w-[90%] md:w-[70%] place-items-center h-screen'>
                ...
                <section className='flex flex-col justify-center items-center w-[90%] md:w-[70%] place-items-center h-screen'>
